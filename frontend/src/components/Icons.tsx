...
export const LockIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}><path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1s3.1 1.39 3.1 3.1v2z"/></svg>
);

export const OtpIcon: React.FC<IconProps> = (props) => (
...
// FIX: Changed props from IconProps to React.HTMLAttributes<HTMLDivElement> because this component returns a div, not an svg.
export const TypingIndicator: React.FC<React.HTMLAttributes<HTMLDivElement>> = (props) => (
...
export const UsersIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226a3 3 0 00-4.682-2.72 3 3 0 00-4.682 2.72m6.3-4.845A9.086 9.086 0 0112 3c2.717 0 5.192 1.033 7.024 2.72m-7.024 4.846A9.088 9.088 0 0012 15.75c-2.717 0-5.192-1.033-7.024-2.72m14.048 0a9.094 9.094 0 01-3.742-.479m-6.3 4.845a9.088 9.088 0 01-7.024-2.72" /></svg>
);

export const MegaphoneIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M10.34 3.94A.75.75 0 0111 4.5v1.4l2.293 2.293a1 1 0 01.287.707v4.286a1 1 0 01-1 1h-1.114a1 1 0 00-1 1v1.114a1 1 0 01-1 1H4.5a1 1 0 01-1-1v-4.286a1 1 0 01.287-.707L5.6 7.4a.75.75 0 011.06 0l1.415 1.414a.75.75 0 001.06 0l1.15-1.15a.75.75 0 011.06 0l1.414 1.414a.75.75 0 001.06 0l.414-.414M12.586 16.586a1 1 0 01-1.414 0L10.5 15.75a.75.75 0 010-1.06l1.414-1.414a.75.75 0 011.06 0l.414.414a1 1 0 010 1.414l-1.15 1.15z" /></svg>
);
