            ...
            <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
                ...
                {user && (
                    <button
                        ...
                        className="text-xs px-3 py-1 rounded-md bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
