        ...
        <div className="space-y-6">
            ...
            {isLoadingData ? (
             ...
             <div className="space-y-6">
                ...
                <InfoCard title="Today's Timetable" icon={<CalendarIcon className="w-6 h-6 text-green-500" />}>
                    <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                        <li className="p-2 bg-gray-100 dark:bg-gray-800 rounded-md"><strong>09:00 AM:</strong> Physics 101 (Room 201)</li>
                        <li className="p-2 bg-gray-100 dark:bg-gray-800 rounded-md"><strong>11:00 AM:</strong> Chemistry Lab (Lab A)</li>
                        <li className="p-2 bg-gray-100 dark:bg-gray-800 rounded-md"><strong>01:00 PM:</strong> Lunch Break</li>
                        <li className="p-2 bg-gray-100 dark:bg-gray-800 rounded-md"><strong>02:00 PM:</strong> Mathematics 202 (Room 305)</li>
                    </ul>
                </InfoCard>
            </div>
            )}
