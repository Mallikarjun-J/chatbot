...
# Import routers
from app.routes import auth, users, announcements, timetables, teacher_timetables, teacher_classes, documents, scraping, file_upload, cgpa, attendance, profile  # , semanticSearch, knowledge_base
